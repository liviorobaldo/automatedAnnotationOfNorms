...
function addAnnotation() {
    ...
    const subsection = document.getElementById('subsection').value.trim();
    ...
    document.getElementById('annotations-area').value += `Section: ${section} - Subsection ${subsection}\n`;
    document.getElementById('annotations-area').value += `IT IS ${deontic}\nFOR ${forEntity}\nTO ${action}\n`;
...
function clearFormFields() {
    // Clear the new section and subsection fields
    document.getElementById('section').value = '';
    document.getElementById('subsection').value = '';
    
    // Clear the rest of the form fields
